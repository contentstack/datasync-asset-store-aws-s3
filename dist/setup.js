...
const debug = (0, debug_1.default)('s3-setup');
let S3;
const factory = (method, config) => {
    debug(messages_1.MESSAGES.FACTORY_CONFIG(config));
    return S3[method](config).promise().then((result) => {
        debug(messages_1.MESSAGES.FACTORY_RESULT(result));
        return;
    });
};
const init = (config) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            (0, validations_1.validateConfig)(config);
